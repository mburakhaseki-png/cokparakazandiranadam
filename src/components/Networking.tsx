...
export function Networking() {
    ...
    return (
        <section id="networking" className="relative min-h-screen py-32 bg-[#050505] overflow-hidden flex items-center">
                    ...
                    <div className="flex flex-col justify-center">
                        ...
                        <div className="mb-12">
                            ...
                            <motion.p
                                ...
                                className="text-xl text-gray-300 leading-relaxed font-light mb-8"
                            >
                            ...
                            <motion.div
                                ...
                                className="p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm mb-12"
                            >
